...
export default function TopBar({ queues }: TopBarProps) {
  ...
  return (
    <div className="absolute top-3 right-3 z-30 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-card/80 backdrop-blur-sm border border-border text-[11px]">
