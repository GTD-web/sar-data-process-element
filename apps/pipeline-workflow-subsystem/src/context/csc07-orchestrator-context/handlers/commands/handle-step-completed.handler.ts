...
import { STEP_RESOLVER, type IStepResolver, PIPELINE_EXECUTION_REPOSITORY, type IPipelineExecutionRepository } from '@sdpe/pipeline';
import { AUDIT_LOG_WRITER, type IAuditLogWriter, AuditEventType } from '@sdpe/audit-log';
import { METRIC_RECORDER, type IMetricRecorder } from '@sdpe/monitoring';
...
export class HandleStepCompletedHandler implements ICommandHandler<HandleStepCompletedCommand> {
  private readonly logger = new Logger(HandleStepCompletedHandler.name);
